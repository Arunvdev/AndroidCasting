...
2. Open the project in Android Studio (Giraffe or newer) and let it sync dependencies (Compose, ExoPlayer, Cling, NanoHTTPD, Coil, Koin, etc.). The build is preconfigured with the official 4thline Maven repository so the Cling artifacts resolve without manual setup.
